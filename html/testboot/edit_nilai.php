...
$nim=$_GET['nim'];
$prodi=$_GET['prodi'];
$pilih_data=mysql_query("select nim from data_mhsw where nim='$nim'");
...
<form action="?menu=proseseditnilai&mk=<?PHP echo $kod ?>&prodi=<?php echo $prodi ?>" method="post" enctype="multipart/form-data" name="form1">
  <div align="center">
