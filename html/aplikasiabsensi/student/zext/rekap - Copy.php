	...
	<body>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "alert alert-info">Rekap</div>
						<center><h2>Rekap Data Absensi <?php echo htmlentities($admin_name)?></h2></center></br>
		...
		?>
				...
				<?php
				$gmail = ("SELECT student.namalengkapmhs, student.kelas_id, dosen.gmail FROM student JOIN dosen ON dosen.nip = student.nip_walikelas WHERE student.kelas_id='3A' ORDER BY student.namalengkapmhs ASC");
				$query = mysqli_query($koneksi,$gmail);
				while($row=mysqli_fetch_array($query, MYSQLI_ASSOC)){
				$gmail_dosen=$row["gmail"];
				}
					$kirimgmail=$jumlah_alfa*1;
					if ($kirimgmail==7){
					mail("","Peringatan Mahasiswa", 'Dear Bapak/Ibu yang terhormat, Diberitahukan bahwa mahasiswa bernama '.$admin_name.'sebentar lagi mendapatkan SP1. Mohon kepada bapak/ibu untuk menegur dan membimbing mahasiswa tersebut.', "From: sippolban@gmail.com");
					}
				?>
				<?php
			echo $admin_name;
