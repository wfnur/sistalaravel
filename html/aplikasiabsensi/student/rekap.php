	...
	<body>
		...
		?>
				...
				<?php
					...
					if ($kirimgmail==7){
					mail(''.$gmail_dosen.'',"Peringatan Mahasiswa", 'Kepada Bapak/Ibu yang terhormat, Diberitahukan bahwa mahasiswa bernama <'.$admin_name.'> sebentar lagi mendapatkan SP1. Mohon kepada bapak/ibu untuk menegur dan membimbing mahasiswa tersebut.', "From: sippolban@gmail.com");
					}
				?>
				<?php
			echo $admin_name;
