...
<html lang = "eng">
	...
	if(isset($_POST['update'])){
		...
		$conn->query("UPDATE `student` SET `uid` = '$uid',`nim` = '$nim', `namalengkapmhs` = '$namalengkapmhs', `kelas_id` = '$kelas_id', `prodi_id` = '$prodi_id', `nip_walikelas` = '$nip_walikelas',`username` = '$username', `password` = '$password' WHERE `student_id` = '$student_id'");
...
<form method = "POST">
	<div class  = "modal-body">
		<div class = "form-group">
			...
			<input type = "text" id = "id"  name = "id" value = "<?php echo $f_edit_student['student_id']?>" class = "form-control" readonly>
		</div>
		<div class = "form-group">
	...
	<div class = "modal-footer">
		<button  type = "submit" class = "btn btn-primary"  name = "update" ><span class = "glyphicon glyphicon-edit"></span>Save Changes</button>
	</div>
</form>	
					</div>
				</form>
