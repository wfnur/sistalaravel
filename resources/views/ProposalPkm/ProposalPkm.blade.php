                ...
                <div class="card-body">
                  <div class="tab-content" id="custom-tabs-two-tabContent">
                      ...
                      <div class='row'>
                          <div class='col-md-12'>
                            <form action="simpan_finalisasi" method="post" id='finalisasiform_pendahuluan'>
                              ...
                              <button class='btn btn-lg btn-success col-md-12' id='btnfinalisasi-pendahuluan' style="display:none"> Finalisasi</button>
                            </form>
                          </div>
                      </div>
                    </div>
                        ...
                        <div class='row'>
                          <div class='col-md-12'>
                            <form action="simpan_finalisasi" method="post" id='finalisasiform_tinpus'>
                              ...
                              <button class='btn btn-lg btn-success col-md-12' id='btnfinalisasi-tinpus' style="display:none"> Finalisasi</button>
                            </form>
                          </div>
                        </div>
                    </div>
                        ...
                        <div class='row'>
                          <div class='col-md-12'>
                            <form action="simpan_finalisasi" method="post" id='finalisasiform_metode'>
                              ...
                              <button class='btn btn-lg btn-success col-md-12' id='btnfinalisasi-metode' style="display:none"> Finalisasi</button>
                            </form>
                          </div>
                        </div>
                    </div>
                      ...
                      <div class='row'>
                        <div class='col-md-12'>
                          <form action="simpan_finalisasi" method="post" id='finalisasiform_biayaKegiatan'>
                            ...
                            <button class='btn btn-lg btn-success col-md-12' id='btnfinalisasi-biayaKegiatan' style="display:none"> Finalisasi</button>
                          </form>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="daftar-pustaka" role="tabpanel" aria-labelledby="daftar-pustaka-tab">
                      ...
                      <div class='row'>
                        <div class='col-md-12'>
                          <form action="simpan_finalisasi" method="post" id='finalisasiform_dapus' style="display:none">
                            {{ csrf_field() }}
                            <input type="hidden" name="nim" value="{{auth()->user()->username}}">
                            <input type="hidden" name="revisike" value="{{$revisike}}">
                    ...
                    <div class="tab-pane fade" id="justifikasi-organisasi" role="tabpanel" aria-labelledby="justifikasi-organisasi-tab">
                      <form method='post' action='' id="formJustifikasiOrganisasi">
                        ...
                        <div class='row'>
                          <div class='col-md-12'>
                            <form action="simpan_finalisasi" method="post" id='finalisasiform_JustifikasiOrganisasi' style="display:none">
                              {{ csrf_field() }}
                              <input type="hidden" name="nim" value="{{auth()->user()->username}}">
                              <input type="hidden" name="revisike" value="{{$revisike}}">
...
@push('scripts') 
    ...
    <script type="text/javascript">
        $(function () {
          ...
          $.ajax({ url: "{{url('/Proposal/PKM/0/get')}}",
            ...
            success: function(data){
              ...
              if(data.data.pendahuluan != ""){
                $('#btnfinalisasi-pendahuluan').css('display','block');
              ...
              if(data.data.biaya !=null && data.data.jadwal_kegiatan !=null){
                $('#btnfinalisasi-biayaKegiatan').css('display','block');
              ...
              if(data.data.tinjauan_pustaka_1 !=null && data.data.tinjauan_pustaka_2 !=null){
                $('#btnfinalisasi-tinpus').css('display','block');
              ...
              if(data.data.metode_pelaksanaan !=null ){
                $('#btnfinalisasi-metode').css('display','block');
              ...
              if(data.data.pustaka_1 !=null && data.data.pustaka_2 !=null && data.data.pustaka_3 !=null && data.data.pustaka_4 !=null && data.data.pustaka_5 !=null ){
                $('#finalisasiform_dapus').css('display','block');
              ...
              if(data.data.justifikasi_anggaran !=null && data.data.susunan_organisasi !=null  ){
                $('#finalisasiform_JustifikasiOrganisasi').css('display','block');
              ...
              if(data.data.pengesahan !=null  ){
                console.log(data.data.pengesahan);
